...
@testset "Daedalus sampler" begin
    @testset "sample_daedalus runs end-to-end" begin
        ...
        chains, logZ, strategy = sample_daedalus(target, data;
    ...
    @testset "noise toggling — runs end-to-end" begin
        # Daedalus now supports td.noise=true via the existing prior-draw
        ...
        chains, logZ, _ = sample_daedalus(target, data;
    ...
    @testset "evidence ordering: more data → higher log Z" begin
        ...
        function _run(n_obs)
            ...
            _, logZ, _ = sample_daedalus(target, data;

...
println("="^70)
println("HD 18599 — Vines Run 2 setup but WITHOUT external e prior")
println("="^70)
...
params = Params(;
    ...
    trend_order     = 1,
    # External N(0, 0.3²) eccentricity prior DROPPED to isolate its
    # effect on the K posterior. Linear BIS decorrelation unchanged.
)

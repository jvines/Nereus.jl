...
const RESULTS = joinpath(@__DIR__, "menu_WASP47_tdptemcee_v2_results.txt")
...
try
    ...
    try save_chains(joinpath(@__DIR__, "wasp47_tdptemcee_chains_v2.nc"), res.chains, params; data=data) catch end
